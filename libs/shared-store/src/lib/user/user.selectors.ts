...
export const getIsNewUser = createSelector(getUserState, (state: UserState) => state.isNewUser)
export const getUserSettings = createSelector(getUserState, (state: UserState) => state.settings)