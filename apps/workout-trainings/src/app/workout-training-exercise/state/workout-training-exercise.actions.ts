...
export const ADD_ANONYMOUS_USER_TRAINING_EXERCISE_SERIE_ERROR   = 'ADD ANONYMOUS USER TRAINING EXERCISE SERIE Error'
export const addAnonymousUserTrainingExerciseSerieRequestError = createAction(ADD_ANONYMOUS_USER_TRAINING_EXERCISE_SERIE_ERROR)