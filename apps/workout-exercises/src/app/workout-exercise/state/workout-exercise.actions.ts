...
export const getAuthenticatedUserExerciseTemplateDetailsRequestSuccesss = createAction(GET_AUTHENTICATED_USER_EXERCISE_TEMPLATE_DETAILS_SUCCESS, props<{ exercise: ExerciseTemplate}>())
